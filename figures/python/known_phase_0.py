...
data_storage = s_d.StoreData(name='known_phase_0')
...
graph_maker = g_m.GraphMaker('known_phase_0.svg', folder_name='figures')
...
ax_h = graph_maker.create_ax(x_slice=0, y_slice=0, # pylint: disable=invalid-name
                             title=(r"""Known previous sample phases, """
                                    r"""$h_f = \num{""" f'{np.round(H_F*1e14)/1e14:8.2e}' r"""}$"""), # type: ignore
                             title_loc='left',
